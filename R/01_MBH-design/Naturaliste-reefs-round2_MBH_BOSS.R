...
# Task:    Create a sampling plan biased off roughness - Naturaliste Reefs BOSS
...
e <- extent(114.955, 115.08, -33.34, -33.26)
...
write.csv(samp,"data/mbh-design/NATREEF_ROUND2_BOSS_MBH_wgs84.csv", row.names = F) # write out the each region
